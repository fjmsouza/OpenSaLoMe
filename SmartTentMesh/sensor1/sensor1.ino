...
Task taskSendMessage( TASK_SECOND * 3600 , TASK_FOREVER, &sendMessage );
...
void sendMessage() {
  ...
  bmeHumidity = 0; 
  bmePress = 0;
  // Defina o intervalo da tarefa para um valor aleatório em torno de +-1h
  taskSendMessage.setInterval(random(TASK_SECOND * 3540, TASK_SECOND * 3660));
}
