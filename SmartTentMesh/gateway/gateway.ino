...
void receivedCallback( uint32_t from, String &msg ) {
  ...
  if (fk_sensor == 1)
  {
    recebidoNOS[0] = true;
    url1 = "";
    char *GScriptId = "AKfycbxklgl5XA9DGZJpPmUR17UG7OAJBPDCfGbuT9TptCCaxUjLmNiEglSpAPaPAQtBMtl_8w"; //planilha SmartTentEnvironmentalSensor1
  ...
  } else if (fk_sensor == 2)
  {
    recebidoNOS[1] = true;
    url2 = "";
    char *GScriptId = "AKfycbwqEr5jlf5LqC3LzxToBOYVk5SH4l2UiNOIhRYCZAW9PdMAuQ-4j50aG1L-olxpMNlO"; //planilha SmartTentEnvironmentalSensor2
